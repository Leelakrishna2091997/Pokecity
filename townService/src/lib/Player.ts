...
export default class Player {
  ...
  get pokemonBag(): Pokemon[] | undefined {
    if (this._pokemonBag !== undefined) {
      return this._pokemonBag;
    }
    return undefined;
  }

  get firstPokemon(): Pokemon | undefined {
    if (this._pokemonBag !== undefined) {
      return this._pokemonBag[0];
    }
    return undefined;
  }
